...
use crate::core::runtime::RuntimeRef;
...
static CACHED_RUNTIME: OnceLock<RuntimeRef> = OnceLock::new();
...
/// Get cached runtime ref
#[inline(always)]
fn get_runtime_ref() -> &'static RuntimeRef {
    CACHED_RUNTIME.get_or_init(|| get_global_runtime().handler())
}
...
impl InterpreterPool {
    ...
    /// Execute a request directly without going through WorkerPool
    /// This reduces latency by eliminating one layer of channel communication
